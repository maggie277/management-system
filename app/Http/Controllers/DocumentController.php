...
class Document extends Model
{
    ...
    // Scope for donor contracts
    public function scopeDonorContracts($query)
    {
        return $query->where('document_type', 'donor_contract')
                    ->orWhereHas('documentCategory', function($q) {
                        $q->where('name', 'Donor Contracts');
                    });
    }
}
