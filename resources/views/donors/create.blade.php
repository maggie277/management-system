<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-semibold text-green-900">Add Donor</h1>
    </x-slot>
    ...
    <div class="container mt-4">
        <form action="{{ route('donors.store') }}" method="POST" class="space-y-4">
            ...
            <div class="flex space-x-2">
                <button type="submit" class="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-800">Save Donor</button>
