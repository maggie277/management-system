<?php
// database/migrations/2025_11_06_100038_create_donor_management_system.php
...
return new class extends Migration
{
    public function up()
    {
        ...
        // Create donor_responsible_persons table
        if (!Schema::hasTable('donor_responsible_persons')) {
        ...
        // Create donor_budget_transactions table
        if (!Schema::hasTable('donor_budget_transactions')) {
